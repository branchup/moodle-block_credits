...
$string['alreadyexipired'] = 'Expiré';
$string['amount'] = 'Montant';
$string['available'] = 'Disponible';
$string['balance'] = 'Silde';
...
$string['creditedon'] = 'Crédit ajouté le';
...
$string['downloadtxs'] = 'Télécharger l\'historique des transactions';
$string['expired'] = 'Expiré';
$string['expirenow'] = 'Mettre à expiration';
$string['expiringsoon'] = 'Expiration prochaine';
$string['extendvalidity'] = 'Etendre la validité';
...
$string['other'] = 'Autre';
$string['pastcredits'] = 'Crédits passés';
...
$string['reasonpurchase'] = 'Achat de crédits, valides jusqu\' {$a->validuntil}.';
